...
| cluster-discovery-prefer-hostnames  | REDIS_EXPORTER_CLUSTER_DISCOVERY_PREFER_HOSTNAMES | Prefer hostnames from the CLUSTER NODES output for the discovery endpoint when available.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
