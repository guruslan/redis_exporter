...
func TestParseClusterNodeString(t *testing.T) {
	tsts := []struct {
		...
		{line: "07c37dfeb235213a872192d90877d0cd55635b91 127.0.0.1:30004@31004,hostname4 slave e7d1eecce10fd6bb5eb35b9f99a514335d9ba9ca 0 1426238317239 4 connected", node: "hostname4:30004", ok: true, preferHostname: true},
		...
		{line: "292f8b365bb7edb5e285caf0b7e6ddc7265d2f4f 127.0.0.1:30003@31003,hostname3 master - 0 1426238318243 3 connected 10923-16383", node: "hostname3:30003", ok: true, preferHostname: true},
		...
		{line: "824fe116063bc5fcf9f4ffd895bc17aee7731ac3 127.0.0.1:30006@31006,hostname6 slave 292f8b365bb7edb5e285caf0b7e6ddc7265d2f4f 0 1426238317741 6 connected", node: "hostname6:30006", ok: true, preferHostname: true},
		...
		{line: "e7d1eecce10fd6bb5eb35b9f99a514335d9ba9ca 127.0.0.1:30001@31001 myself,master - 0 0 1 connected 0-5460", node: "127.0.0.1:30001", ok: true, preferHostname: true},
	...
	for _, tst := range tsts {
		...
		t.Run(tst.line, func(t *testing.T) {
			node, ok := parseClusterNodeString(tst.line, tst.preferHostname)
